...
{ cartInfo == null ? (<Loading/>) : (
 ...
 {cartInfo.length == 0 ? (     <div className='py-16 flex justify-center items-center flex-col '>
  ...
  <>
    ...
    <button
    onClick={clearCart}
     className='btn-primary bg-red-500  block ms-auto mt-4'> clear cart 
     </button>
  </>
    )}
  ...
  <Link to ="/checkout" className='btn-primary uppercase ms-auto block mt-3 w-fit'> Next Step</Link> 
