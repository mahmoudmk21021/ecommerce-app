...
name: Yup.string().required('name is required' ).min(3, "name must be at least 3 charcters").max(15, "name must be at most 15 charcters"),
...
onBlur={formik.handleBlur}
 ...
 {formik.errors.name && formik.touched.name ? (
    <div className='text-red-600 font-semi mt-2 '>* {formik.errors.name}</div>
...
<div>
  ...
  {formik.errors.phone && formik.touched.phone ? (
    <div className='text-red-600 font-semi mt-2 '>* {formik.errors.phone}</div>
